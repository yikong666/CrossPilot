...
RELATIONSHIP_SPECS = [
    ("products.csv", ("Product", "product_id", "BELONGS_TO", "Category", "category_id")),
    ("products.csv", ("Product", "product_id", "MADE_BY", "Brand", "brand_id")),
    ("products.csv", ("Product", "product_id", "SOLD_ON", "Marketplace", "marketplace_id")),
